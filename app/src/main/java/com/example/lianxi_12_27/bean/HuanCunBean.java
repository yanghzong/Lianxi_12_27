package com.example.lianxi_12_27.bean;
...
public class HuanCunBean {
    ...
    public HuanCunBean(double bargainPrice, String createtime, String detailUrl, String images, int pid, String price, String title) {
